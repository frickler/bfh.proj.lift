...
/**
 * The controller is one of the key-logic-classes. It instances the algorithm and 
 * holds a list with all actions who are not performed yet. The algorithm can query
 * the controller for the action with the highest priority similar to a queue.
 * <br>
...
public interface Controller {
	 ...
	 * @throws IllegalActionException Gets called if an action is invalid (invalid levels p.E.)
	 */
	 ...
	 * @param removeId Id of the elevator
	 ...
	 * @param e Elevator to add
	 */
	public void addElevator(Elevator e);

	/**
	 * 
	 * @param building Set the building for the simulation
	 */
	 ...
	 * @param amountAction Amount of actions for this random simulation
	 */
	 ...
	 * @param simulationSpeed Speed of the simulation
	 * @param actions List of action to process
	 */
	...
	/**
	 * After a action is performed, it can 
	 * be saved in the controller for statistic reasons
	 * @param a Processed action
	 */
